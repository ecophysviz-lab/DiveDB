...
To see how to upload files to the data lake, refer to the [upload_docs.ipynb](examples/upload_docs.ipynb) notebook.
...
We use [DuckDB](https://duckdb.org/) to read files from the data lake. To see how to read files from the data lake, refer to the [visualization_docs.ipynb](examples/visualization_docs.ipynb) notebook.
